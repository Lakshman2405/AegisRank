...
class IntelligentRetrievalEngine:
    ...
    def __init__(self, collection_name: str = "hackathon_talent_pool"):
        # REMOVE the remote cloud ecosystem references
    ...
    def run_agentic_ranking_pipeline(self, target_jd: str, sample_size: int = 100):
            """Ranks candidates on CPU, breaks ties deterministically, and generates high-fidelity

            fact-driven reasonings without making external network API calls.
            """
            ...
            for doc, vector_score in matched_docs:
                ...
                compiled_candidates.append({
                    ...
                    "yoe": telemetry.get("years_of_experience", 0.0),
                    ...
                    "search_appearance": telemetry.get("search_appearance_30d", 0)
                })
            ...
            metadata_payload = {
                ...
                "sandbox_link": "https://aegisrank.streamlit.app",
                ...
                "methodology_summary": (
                    ...
                    "multipliers to defeat keyword stuffing."
                ),
                "declarations": {
